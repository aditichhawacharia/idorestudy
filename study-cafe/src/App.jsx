...
const StudyCafe = () => {
  ...
  const studyBuddies = [
    ...
    { id: 5,  name: 'Jungkook',     group: 'BTS',         videoId: 'dQw4w9WgXcQ', isPremium: false, image: 'https://media.allure.com/photos/5d51932d40395d0008565c27/1:1/w_1117,h_1117,c_limit/BTS%20Jungkook%20The%20Fact%20Music%20Awards.jpg' },
    { id: 6,  name: 'V (Taehyung)', group: 'BTS',         videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://img.wattpad.?s=fit&w=720&h=720' },
    { id: 7,  name: 'Jimin',        group: 'BTS',         videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://i0.wp.com/zaloramalaysiablog.wpcomstaging.com/wp-content/uploads/2025/10/JIMIN-FEATURE.jpeg?resize=736%2C768&ssl=1' },
    ...
    { id: 13, name: 'Yujin',        group: 'IVE',         videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFD1DC/000000?text=YUJIN' },
    { id: 14, name: 'Rei',          group: 'IVE',         videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/B0E0E6/000000?text=REI' },
    ...
    { id: 16, name: 'Sakura',       group: 'LE SSERAFIM', videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFD4E5/000000?text=SAKURA' },
    { id: 17, name: 'Kazuha',       group: 'LE SSERAFIM', videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/E6F3FF/000000?text=KAZUHA' },
    { id: 18, name: 'Karina',       group: 'aespa',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/E5CCFF/000000?text=KARINA' },
    { id: 19, name: 'Winter',       group: 'aespa',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/BAE6FF/000000?text=WINTER' },
    { id: 20, name: 'Giselle',      group: 'aespa',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/DDA0DD/000000?text=GISELLE' },
    { id: 21, name: 'Ningning',     group: 'aespa',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFDAB9/000000?text=NINGNING' },
    ...
    { id: 23, name: 'Hanni',        group: 'NewJeans',    videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFF4A3/000000?text=HANNI' },
    { id: 24, name: 'Danielle',     group: 'NewJeans',    videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFE5B4/000000?text=DANIELLE' },
    { id: 25, name: 'Haerin',       group: 'NewJeans',    videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/E0F2F7/000000?text=HAERIN' },
    { id: 26, name: 'Hyein',        group: 'NewJeans',    videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFB6D9/000000?text=HYEIN' },
    { id: 27, name: 'Bang Chan',    group: 'Stray Kids',  videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/4682B4/000000?text=BANGCHAN' },
    { id: 28, name: 'Felix',        group: 'Stray Kids',  videoId: 'dQw4w9WgXcQ', isPremium: false, image: 'https://via.placeholder.com/300x400/FFE4B5/000000?text=FELIX' },
    { id: 29, name: 'Hyunjin',      group: 'Stray Kids',  videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/E6E6FA/000000?text=HYUNJIN' },
    { id: 30, name: 'Nayeon',       group: 'TWICE',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFB3D9/000000?text=NAYEON' },
    { id: 31, name: 'Sana',         group: 'TWICE',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/FFD1DC/000000?text=SANA' },
    { id: 32, name: 'Momo',         group: 'TWICE',       videoId: 'dQw4w9WgXcQ', isPremium: true,  image: 'https://via.placeholder.com/300x400/DDA0DD/000000?text=MOMO' },
  ];

  const groups = ['All', 'BLACKPINK', 'BTS', 'IVE', 'LE SSERAFIM', 'aespa', 'NewJeans', 'Stray Kids', 'TWICE'];
